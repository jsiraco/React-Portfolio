            ...
            <div className="column is-8">
                ...
                <div className="columns">
                    <div className="card">
                        <header className="card-header">
                            <p className="card-header-title">
                                <a href="https://github.com/jsiraco/Code_Quiz_JS" target="_blank">
                                    Code Quiz
                                </a>
                            </p>
                        </header>
                        <div className="card-image">
                            <figure className="image">
                                <a href="https://jsiraco.github.io/Code_Quiz_JS/" target="_blank">
                    ...
                    <div className="card">
                        <header className="card-header">
                            <p className="card-header-title">
                                <a href="https://github.com/OneFJef/Persist" target="_blank">
                                    Persist
                                </a>
                            </p>
                        </header>
                        <div className="card-image">
                            <figure className="image">
                                <a href="https://ancient-ravine-93786.herokuapp.com/" target="_blank">
                ...
                <div className="columns">
                    <div className="card">
                        <header className="card-header">
                            <p className="card-header-title">
                                <a href="https://github.com/jsiraco/PortfolioJSV1" target="_blank">
                                    Portfolio V1
                                </a>
                            </p>
                        </header>
                        <div className="card-image">
                            <figure className="image">
                                <a href="https://jsiraco.github.io/PortfolioJSV1/" target="_blank">
                    ...
                    <div className="card">
                        <header className="card-header">
                            <p className="card-header-title">
                                <a href="https://github.com/jsiraco/inquirer_html_gen" target="_blank">
                                    Inquire HTML Generator
                                </a>
                            </p>
                        </header>
                        <div className="card-image">
                            <figure className="image">
                                <a href="https://jsiraco.github.io/inquirer_html_gen/" target="_blank">
